...
<section class="courses" style="margin: 0;">
   <div style="    display: flex;justify-content: space-around; margin-bottom: 4%;">
      ...
      <a style="background-color: #80808024; color: black;" href="GRADE.php?id=<?php echo $_SESSION['id']; ?>" class="inline-btn">My grades</a>
     </div>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="playlist.php?id=<?php echo $_SESSION['id']; ?>" class="inline-btn">view playlist</a>
      </div>
